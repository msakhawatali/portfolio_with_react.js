...
const socials = [
  {Icon : FaXTwitter, label : "X" , href : "https://x.com/sakahawat92259"},
  {Icon : FaLinkedin, label : "LinkedIn" , href : "https://www.linkedin.com/in/sakhawat-ali-dev/"},
  {Icon : FaGithub, label : "GitHub" , href : "https://github.com/msakhawatali"},
]
...
React.useEffect(() => {
  ...
  const timeout = setTimeout(() => {
    if (!deleting && subIndex < current.length) setSubIndex(v => v + 1);
      ...
      if (!deleting) setTimeout(() => setDeleting(true), 1200);
    }
    ...
    <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
      <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
        <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
          ...
          <motion.h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63] drop-shadow-lg"
          ...
          >
            I turn complex idea into seamless, high-impact web experience -- building modern, scalable, and lighting-fast applications that make a difference.
          </motion.p>
      ...
      <div className="relative hidden lg:block">
        ...
        />
            <motion.img src={avator} alt="Sakhawat Ali" 
            className="absolute top-y-1/2 object-contain select-none pointer-events-none"
            style={{
