...
export default function About(){
  const stats = [
    {label : "Experience" , value : "Self-Projects"},
    {label : "Speciality" , value : "Software Engineer"},
    {label : "Focus" , value : "Backend Developer"},
  ];
  ...
  return(
    ...
    className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12 ">
        <motion.div className="flex flex-col md:flex-row items-center md:items-stretch gap-6 md:gap-10"
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left md:pl-8">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              Software Engineer with hands-on experience building REST APIs and backend applications using Python, FastAPI, Django, and PostgreSQL. 
              Strong understanding of authentication, database design, and software engineering principles, with a passion for backend development and problem-solving.
            </p>
